...
(function ($) {
            ...
            footer: function (inst) {
                ...
                _html = function () {
                    ...
                    if (!inst.inline) {
                        ...
                        html += '<button class="colorpicker-cancel">' + inst._getRegional('cancel') + '</button>';
                        html += '<button class="colorpicker-ok">' + inst._getRegional('ok') + '</button>';
                        html += '</div>';
                    }
                ...
                this.init = function () {
                    ...
                    $('.colorpicker-ok', e).button().click(function (e) {
                        inst.close(e);
                    });

                    $('.colorpicker-cancel', e).button().click(function (e) {
                        inst.color = inst.currentColor.copy();
                ...
                this.repaint = function () {
                    ...
                    $('.colorpicker-cancel', e).button(inst.changed ? 'enable' : 'disable');
                };
	...
	$.widget("vanderlee.colorpicker", {
		options: {
			...
			buttonImage:		'http://d7q85mn3faw4b.cloudfront.net/shared-resources/colorpicker.png',
		...
		_create: function () {
			...
			if (this.element[0].nodeName.toLowerCase() === 'input') {
				...
				this._callback('init');
                                ...
                                var _container_popup = '<div class="ui-colorpicker ui-colorpicker-dialog ui-dialog ui-widget ui-widget-content ui-corner-all" id="'+this.element[0].id+'" style="display: none;"></div>'
				$(_container_popup).insertAfter($(this.element[0]));
